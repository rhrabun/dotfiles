#!/bin/zsh
# =============================================================================
# moveToBrew.sh — Replace apps in /Applications with Homebrew casks/formulas.
#
# Scans /Applications, searches Homebrew for a matching cask (or formula for
# CLI tools), and interactively prompts before installing each candidate.
#
# Adapted from:
#   moveToBrew.sh by TrudeEH
